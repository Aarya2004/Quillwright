...
#
# Source : github.com/OpenBMB/MiniCPM-V  finetune/finetune.py
...
# Raw URL: https://raw.githubusercontent.com/OpenBMB/MiniCPM-V/cd64150b5122f8ee8c677d481c97918485129b52/finetune/finetune.py
...
# paths below are only entered when --deepspeed is set (it is not) or q_lora is
# true (it is not). So the image can omit deepspeed entirely.
try:
    from deepspeed import zero  # noqa: F401
    from deepspeed.runtime.zero.partition_parameters import ZeroParamStatus  # noqa: F401
