...
ADAPTER_DEFAULT = "Aarya2004/minicpmv-cord-lora"
...
def evaluate(
    ...
    if baseline_only:
        ...
        with open("/cache/cord/results.json", "w") as f:
            json.dump(results, f, indent=2)
        vol.commit()
        print("\n=== CORD line-item extraction: baseline only (--baseline-only) ===")
    ...
    print("\n=== CORD line-item extraction: baseline vs tuned ===")
